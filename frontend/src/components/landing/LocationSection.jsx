    ...
    <section id="location" className="relative py-28 bg-[#272727]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <h2 className="mb-4 text-4xl font-bold text-white md:text-6xl">Location</h2>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          >
            ...
            <h3 className="text-2xl font-semibold text-white">A. Y. Jackson SS</h3>
            <p className="mt-2 text-gray-300">A. Y. Jackson SS</p>

            <div className="mt-8 space-y-4 text-gray-200">
              <div className="flex items-center gap-3">
                <CalendarDays size={18} className="text-[#F68A42]" />
                <span>November 21st, 2026 (Saturday)</span>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span>Parking and transit info shared before check-in</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 flex h-full min-h-[280px] flex-col justify-between rounded-2xl border border-white/20 bg-[#272727]/45 p-6 backdrop-blur-sm">
              <div>
                <p className="text-sm uppercase tracking-widest text-[#2072C7]">Campus Zone</p>
                <p className="mt-3 text-2xl font-semibold text-white">Easy to Find. Easy to Build.</p>
